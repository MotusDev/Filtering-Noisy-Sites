...
Most of these sites should be re-run with stronger tag-finder parameters. This could be done now, but will be easier when we have the ability to replace batches within the database (including the local copy).

Filtering will still be useful after this point, mostly for assessing the veracity of short runLen hits.
